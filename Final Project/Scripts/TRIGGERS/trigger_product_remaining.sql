DROP TRIGGER IF EXISTS product_remaining;
DELIMITER //
CREATE TRIGGER product_remaining
AFTER INSERT ON order_items
FOR EACH ROW
BEGIN
	DECLARE album_id_var INT;
    DECLARE bought_product_var INT;
    ...
    SELECT new.quantity
    INTO bought_product_var
    ;
    
    
    SELECT product_remaining - bought_product_var
